...
<meta name="apple-mobile-web-app-title" content="Unique Living Effretikon" />
<link rel="manifest" href="/site.webmanifest" />
@vite('resources/css/app.css')
@livewireStyles
</head>
<body class="antialiased font-basic-regular text-graphite text-sm md:text-base leading-[1.3] flex min-h-full flex-col">
